...
def online_eval(model, dataloader_eval, gpu, ngpus):
    ...
    if args.multiprocessing_distributed:
        ...
        dist.reduce(tensor=eval_measures, op=dist.ReduceOp.SUM, group=group, dst=0)
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    # Training parameters
    # optimizer = torch.optim.AdamW([{'params': model.module.encoder.parameters(), 'lr': 0.1 * args.weight_decay, 'weight_decay': args.weight_decay},
    #                                {'params': model.module.decoder.parameters(), 'lr': args.weight_decay, 'weight_decay': 0}],
    #                               eps=args.adam_eps)
